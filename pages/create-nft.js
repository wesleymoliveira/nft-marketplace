...
const CreateNFTs = () => {
  ...
  const fileStyle = useMemo(() => (
    `dark:bg-nft-black-1 bg-white border dark:border-white boder-nft-gray-2 flex flex-col items-center p-5 rounded-sm border-dashed 
    ...
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-3/5 md:w-full">
        ...
        <div className="mt-7 w-full flex justify-end">
          <Button handleClick={(e) => setFormInput({ ...formInput, name: e.target.value })} classStyles="rounded-xl" btnName="Create NFT" />
